...
public class C06Basic {
	public static void main(String[] args) {
		// 연산자 : 산술연산자 / 대입연산자 / 복합대입연산자 / 비교연산자 / 논리연산자 / 삼항연산자 / 증감연산자....
...
//		System.out.println(score + "점은 " + grade + "등급입니다.");
		...
		// 총점수 평균이 70점이상이면 '합격' 미만이면 '불합격'을 출력합니다
...
//		String str = (korean>=40 && english >=40 && math>=40 && avg >=70) ? "합격" : "불합격";
//		System.out.printf("국어: %d, 영어: %d, 수학: %d, 평균: %d, %s",korean,english,math,avg,str);
