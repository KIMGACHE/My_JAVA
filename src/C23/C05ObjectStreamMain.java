...
class Board implements Serializable { // 원격으로 전달할 때?
	...
	public Board(int bno, String title, String content, String writer, Date data) {
		super();
		this.bno = bno;
		this.title = title;
	...
	public String toString() {
		return "Board [bno=" + bno + ", title=" + title + ", content=" + content + ", writer=" + writer + ", data="
				+ data + "]";
	}
...
//		out.close();
		...
		// 더 이상 읽을것이 없으면 java.io.EOFEXception 발생
